<?php
    ...
    /* stage */
    $get_stage=$db->getData("stage","*","isDelete=0 AND user_id=".$user_id." AND lesson_id=".$lesson_id."");
    ...
    else
    {
        ...
        $stage = $db->insert("stage", $stage_arr);
    }
    ...
    if (isset($_REQUEST['pre_module_submit'])) 
    {
        ...
        $pre_module_save = $db->insert("pre_module_form",$pre_moduel_arr);
        ...
        if ($pre_module_save != "") 
        {
            ...
            $_SESSION['MSG'] = "SaveAns";
            $db->location(SITEURL."lesson-details/".$lesson_id."/");
        }
        else
        {
            $_SESSION['MSG'] = "Something_Wrong";
            $db->location(SITEURL."pre-module-form/".$module_id."/".$lesson_id."/");
        }
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="Pre-list-sec">
                            ...
                            <div class="Module-question">
                                <form class="gform_fields" name="pre_module_form" id="pre_module_form" method="post" action=".">
                                    ...
                                    <div class="form-group">
                                        <button class="w-100 Sign_Up-btn" name="pre_module_submit" id="pre_module_submit" type="submit">SUBMIT</button>
                                    </div>
                                </form>
                            </div>
                        </div>
