            ...
            <tbody>
                ...
                if(@mysqli_num_rows($ctable_r)>0){
                    ...
                    <tr>
                        ...
                        <?php
                            $get_user_name=$db->getData("user","*","id=".$ctable_d['user_id']."");
                            $ctable_d_user=mysqli_fetch_assoc($get_user_name);

                        ?>
                        <td><?php echo $ctable_d_user['name']; ?></td>
                        <td><?php echo $ctable_d['course_name']; ?></td>
                        <td><?php echo $ctable_d['amount']; ?></td>
                        <td><?php echo date("d-m-Y", strtotime($ctable_d['purchase_date'])); ?></td>
                        <?php
                            if($ctable_d['payment_method']==1)
                            {
                                $method="Stripe";
                            }
                            else
                        ...
                        <td><?php echo $ctable_d['transaction_id']; ?></td>
                        <?php
