			...
			<tbody>
				...
				if(@mysqli_num_rows($ctable_r)>0){
					...
					<tr>
						...
						<td>
							<?php if($ctable_d['isActive'] == 1){ echo "<i class='fa fa-check'></i>"; } else { echo "<i class='fa fa-times'></i>"; } ?>
						</td>
						<td>
							<a style="color: #36b9cc;" href="<?php echo ADMINURL; ?>Manage-User-Course/<?php echo $ctable_d['id']; ?>/" title="Course"><i class="fa fa-list"></i></a>
