<?php
	...
	$user_nm=$db->getData("user","*","id=".$user_id);
	$user_row=mysqli_fetch_assoc($user_nm);
	$page_title = $user_row['name'];
...
<body id="page-top">
										...
										<div class="box-header with-border">
											<div class="col-md-12 ">
												<form action="#" onSubmit="return searchByName();">
													<input type="hidden" name="lession_id" id="lession_id" value="<?=$lesson_id?>">
	...
	function displayRecords(numRecords) {
		...
		lession_id 	    = encodeURIComponent(lession_id.trim());
		var user_id 	= $("#user_id").val();
		user_id 	    = encodeURIComponent(user_id.trim());
		var data_url    = "<?php echo ADMINURL; ?>get_user_lesson.php?show=" + numRecords + "&searchName=" + searchName+"&lession_id="+lession_id+"&user_id="+user_id;
		$("#results").html("");
		$(".loading-div").show();
