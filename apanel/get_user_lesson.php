<?php
	...
	$ctable_where .= "isDelete=0 AND module_id=".$_REQUEST['lession_id']."";
			...
			<tbody>
				...
				if(@mysqli_num_rows($ctable_r)>0){
					...
					<tr>
						...
						<td>
							<a style="color: #36b9cc;" href="<?php echo ADMINURL; ?>Manage-User-Form/<?php echo $ctable_d['id']; ?>/<?php echo $_REQUEST['user_id']; ?>" title="Questions"><i class="fa fa-list"></i></a>
