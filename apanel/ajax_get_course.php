<?php
	...
	if(isset($_REQUEST['searchName']) && $_REQUEST['searchName']!=""){
		$ctable_where .= " (
					...
					short_description like '%".$_REQUEST['searchName']."%'
		) AND ";
	}
			...
			<tbody>
				...
				if(@mysqli_num_rows($ctable_r)>0){
					...
					<tr>
						...
						<td>
	                		<a class="text-success" href="<?php echo ADMINURL; ?>manage-module/<?php echo $ctable_d['id']; ?>/" title="Modules"><i class="fa fa-list"></i></a>
							...
							<a class="text-primary" href="<?php echo ADMINURL; ?>manage-membership/<?php echo $ctable_d['id']; ?>/" title="Membership"><i class="fa fa-users"></i></a>
