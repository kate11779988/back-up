...
<body id="page-top">
										...
										<div class="box-header with-border">
											<div class="col-md-12 ">
												<form action="#" onSubmit="return searchByName();">
													<input type="hidden" name="course_id" id="course_id" value="<?=trim($_REQUEST['id']);?>">
													<div class="row">
														<div class="col-md-3">
	...
	function displayRecords(numRecords) {
		...
		course_id 	    = encodeURIComponent(course_id.trim());
		var data_url    = "<?php echo ADMINURL; ?>ajax_get_<?php echo $ctable; ?>.php?show=" + numRecords + "&searchName=" + searchName+"&course_id="+course_id;
		$("#results").html("");
		$(".loading-div").show();
