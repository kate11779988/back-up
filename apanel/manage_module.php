<?php
	...
	$course_name = $db->getValue('course', 'name', 'id='. $course_id);
?>
...
<body id="page-top">
			...
			<div id="content">
				...
				<div class="container-fluid">
					<div class="d-sm-flex align-items-center justify-content-between mb-4">
						<h1 class="h4 mb-0 text-gray-900"><?php echo $page_title; echo ($course_id>0)?' : <strong>' . $course_name . '</strong>':''; ?></h1>
					</div>
					<div class="row">
						<div class="col-md-12">
	...
	function displayRecords(numRecords) {
		...
		var data_url    = "<?php echo ADMINURL; ?>ajax_get_<?php echo $ctable; ?>.php?show=" + numRecords + "&searchName=" + searchName + "&course_id=<?php echo $course_id; ?>";
		$("#results").html("");
		$(".loading-div").show();
